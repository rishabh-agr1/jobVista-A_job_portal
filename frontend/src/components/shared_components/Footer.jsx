...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-8 text-red-100 bg-indigo-900">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Job<span className='text-[#F83002]'>Vista</span></h2>
            <p className="text-sm">© 2025 JobVista. All rights reserved.</p>
          </div>

          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-12 text-sm text-gray-300">
            <div>
        ...
        <div className="mt-6 text-center text-gray-400 text-sm">
          <p>Designed and Developed by JobVista Team</p>
        </div>
      </div>
    </footer>
  );
